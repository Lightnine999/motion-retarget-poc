...
OUT = "/Users/kwonkwanggoo/motion-retarget-poc/outputs/kaggle_tennis/mixamo_rokoko_despiked3.fbx"

HARD_CEILING_DEG = {
    "mixamorig10:Hips": 12.0,
    "mixamorig10:Spine": 10.0,
    "mixamorig10:Spine1": 10.0,
    "mixamorig10:Spine2": 10.0,   # SMPL Spine3에 해당, 사용자 지목 관절
    "mixamorig10:Neck": 15.0,
    "mixamorig10:Head": 15.0,
    "mixamorig10:LeftShoulder": 15.0,
    "mixamorig10:RightShoulder": 15.0,
...
SPIKE_RETURN_MIN = 10.0   # 이전 20 -> 10 (더 민감하게)
SPIKE_RETURN_RATIO = 0.45

SKIP_BONES = {"mixamorig10:LeftHand", "mixamorig10:RightHand"}  # 매핑 안 된 손가락 뭉치, 노이즈성이라 제외
...
all_bones = [pb.name for pb in armature.pose.bones if pb.rotation_mode == "QUATERNION" and pb.name not in SKIP_BONES]
